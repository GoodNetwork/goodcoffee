        ...
        <div class="cover-wrapper container">
            <div class="listify_widget_search_listings">
                <hgroup class="home-widget-section-title">
                    <h1 class="home-widget-title">Main Text</h1>
                    <h2 class="home-widget-description">Sub text</h2>
                </hgroup>
            </div>
        </div>
